...
it's nice to see whether it's warm right now.
		...
		<p><a class="btn" href="/page/sauna">View status &raquo;</a>
<a href="/page/what" class="btn btn-info" rel="popover" data-original-title="How and why" data-content="We have 1-wire temperature sensor hidden in the corner of the sauna. It's connected to arduino, which forwards temperature information to server.">How and why</a></p>
...
number."><span class="badge badge-info" id="unique_7d"><span class="loading-inline-micro-gif"></span></a>
		...
		<p><a class="btn" href="/page/it-tickets">View statistics &raquo;</a>
