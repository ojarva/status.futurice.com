...
1E3);$("#uptime_graph").empty();$("#uptime_graph").css("height",400).css("width",1E3);var b=Raphael("uptime_graph"),a=function(){this.flag.remove()};b.barchart(0,10,900,400,[c,d,e],{stacked:!0}).hover(function(){this.flag=b.popup(this.bar.x,this.bar.y,this.bar.value+"%"||"?%").insertBefore(this)},a);b=Raphael("response_graph");b.barchart(0,10,900,400,[f]).hover(function(){this.flag=b.popup(this.bar.x,this.bar.y,this.bar.value+"ms"||"?ms").insertBefore(this)},a)}
