...
for(;g;){e.unshift(g);g=g.parentNode}for(g=d;g;){f.unshift(g);g=g.parentNode}c=e.length;d=f.length;for(g=0;g<c&&g<d;g++)if(e[g]!==f[g])return q(e[g],f[g]);return g===c?q(a,f[g],-1):q(e[g],b,1)};q=function(a,b,c){var d;if(a===b)return c;for(;d;){if(d===b)return-1;d=d.nextSibling}return 1}}(function(){var a=k.createElement("div"),b="script"+(new Date).getTime(),c=k.documentElement;a.innerHTML="<a name='"+b+"'/>";c.insertBefore(a,c.firstChild);if(k.getElementById(b)){n.find.ID=function(a,b,c){if(typeof b.getElementById!==
"undefined"&&!c)return(b=b.getElementById(a[1]))?b.id===a[1]||typeof b.getAttributeNode!=="undefined"&&b.getAttributeNode("id").nodeValue===a[1]?[b]:l:[]};n.filter.ID=function(a,b){var c=typeof a.getAttributeNode!=="undefined"&&a.getAttributeNode("id");return a.nodeType===1&&c&&c.nodeValue===b}}c.removeChild(a);c=a=null})();(function(){var a=k.createElement("div");a.appendChild(k.createComment(""));if(a.getElementsByTagName("*").length>0)n.find.TAG=function(a,b){var c=b.getElementsByTagName(a[1]);
...
function popover_placement(j,i){var d=$(i),e=$(window).height(),b=$(window).width(),c=d.offset().left,d=d.offset().top,a={},b=b-c,e=e-d,h=0,g=!1;if(150<d&&(a.top=d,150>c||150>b))a.top=Math.min(c,b);if(150<e&&(a.bottom=e,150>c||150>b))a.bottom=Math.min(c,b);250<c&&(a.left=c/2);250<b&&(a.right=b/2);var g="bottom",f;for(f in a)a[f]>h&&(h=a[f],g=f);return g};
...
!function(b){b(function(){var c=b.support,a=(document.body||document.documentElement).style;if(a=void 0!==a.transition||void 0!==a.WebkitTransition||void 0!==a.MozTransition||void 0!==a.MsTransition||void 0!==a.OTransition)a="TransitionEnd",b.browser.webkit?a="webkitTransitionEnd":b.browser.mozilla?a="transitionend":b.browser.opera&&(a="oTransitionEnd"),a={end:a};c.transition=a})}(window.jQuery);
!function(b){var a=function(e){b(e).on("click",'[data-dismiss="alert"]',this.close)};a.prototype={constructor:a,close:function(e){function f(){d.trigger("closed").remove()}var c=b(this),a=c.attr("data-target"),d;a||(a=(a=c.attr("href"))&&a.replace(/.*(?=#[^\s]*$)/,""));d=b(a);d.trigger("close");e&&e.preventDefault();d.length||(d=c.hasClass("alert")?c:c.parent());d.trigger("close").removeClass("in");b.support.transition&&d.hasClass("fade")?d.on(b.support.transition.end,f):f()}};b.fn.alert=function(e){return this.each(function(){var f=
b(this),c=f.data("alert");c||f.data("alert",c=new a(this));"string"==typeof e&&c[e].call(f)})};b.fn.alert.Constructor=a;b(function(){b("body").on("click.alert.data-api",'[data-dismiss="alert"]',a.prototype.close)})}(window.jQuery);
!function(b){function f(){b(g).parent().removeClass("open")}var g='[data-toggle="dropdown"]',d=function(c){var a=b(c).on("click.dropdown.data-api",this.toggle);b("html").on("click.dropdown.data-api",function(){a.parent().removeClass("open")})};d.prototype={constructor:d,toggle:function(){var c=b(this),a=c.attr("data-target");a||(a=(a=c.attr("href"))&&a.replace(/.*(?=#[^\s]*$)/,""));a=b(a);a.length||(a=c.parent());c=a.hasClass("open");f();!c&&a.toggleClass("open");return!1}};b.fn.dropdown=function(c){return this.each(function(){var a=
b(this),e=a.data("dropdown");e||a.data("dropdown",e=new d(this));"string"==typeof c&&e[c].call(a)})};b.fn.dropdown.Constructor=d;b(function(){b("html").on("click.dropdown.data-api",f);b("body").on("click.dropdown.data-api",g,d.prototype.toggle)})}(window.jQuery);
...
this.$element=null)},enable:function(){this.enabled=!0},disable:function(){this.enabled=!1},toggleEnabled:function(){this.enabled=!this.enabled},toggle:function(){this[this.tip().hasClass("in")?"hide":"show"]()}};c.fn.tooltip=function(a){return this.each(function(){var b=c(this),d=b.data("tooltip"),h="object"==typeof a&&a;d||b.data("tooltip",d=new e(this,h));if("string"==typeof a)d[a]()})};c.fn.tooltip.Constructor=e;c.fn.tooltip.defaults={animation:!0,delay:0,selector:!1,placement:"top",trigger:"hover",
title:"",template:'<div class="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>'}}(window.jQuery);
!function(a){var e=function(b,a){this.init("popover",b,a)};e.prototype=a.extend({},a.fn.tooltip.Constructor.prototype,{constructor:e,setContent:function(){var b=this.tip(),d=this.getTitle(),c=this.getContent();b.find(".popover-title")["object"==a.type(d)?"append":"html"](d);b.find(".popover-content > *")["object"==a.type(c)?"append":"html"](c);b.removeClass("fade top bottom left right in")},hasContent:function(){return this.getTitle()||this.getContent()},getContent:function(){var b;b=this.$element;
var a=this.options;b=b.attr("data-content")||("function"==typeof a.content?a.content.call(b[0]):a.content);return b=b.toString().replace(/(^\s*|\s*$)/,"")},tip:function(){this.$tip||(this.$tip=a(this.options.template));return this.$tip}});a.fn.popover=function(b){return this.each(function(){var d=a(this),c=d.data("popover"),f="object"==typeof b&&b;c||d.data("popover",c=new e(this,f));if("string"==typeof b)c[b]()})};a.fn.popover.Constructor=e;a.fn.popover.defaults=a.extend({},a.fn.tooltip.defaults,
...
!function(b){var d=function(a,c){this.$element=b(a);this.options=b.extend({},b.fn.button.defaults,c)};d.prototype={constructor:d,setState:function(a){var c=this.$element,b=c.data(),d=c.is("input")?"val":"html",a=a+"Text";b.resetText||c.data("resetText",c[d]());c[d](b[a]||this.options[a]);setTimeout(function(){"loadingText"==a?c.addClass("disabled").attr("disabled","disabled"):c.removeClass("disabled").removeAttr("disabled")},0)},toggle:function(){var a=this.$element.parent('[data-toggle="buttons-radio"]');
a&&a.find(".active").removeClass("active");this.$element.toggleClass("active")}};b.fn.button=function(a){return this.each(function(){var c=b(this),e=c.data("button"),f="object"==typeof a&&a;e||c.data("button",e=new d(this,f));"toggle"==a?e.toggle():a&&e.setState(a)})};b.fn.button.defaults={loadingText:"loading..."};b.fn.button.Constructor=d;b(function(){b("body").on("click.button.data-api","[data-toggle^=button]",function(a){a=b(a.target);a.hasClass("btn")||(a=a.closest(".btn"));a.button("toggle")})})}(window.jQuery);
!function(c){var e=function(a,b){this.$element=c(a);this.options=c.extend({},c.fn.collapse.defaults,b);this.options.parent&&(this.$parent=c(this.options.parent));this.options.toggle&&this.toggle()};e.prototype={constructor:e,dimension:function(){return this.$element.hasClass("width")?"width":"height"},show:function(){var a=this.dimension(),b=c.camelCase(["scroll",a].join("-")),d=this.$parent&&this.$parent.find(".in"),f;d&&d.length&&(f=d.data("collapse"),d.collapse("hide"),f||d.data("collapse",null));
this.$element[a](0);this.transition("addClass","show","shown");this.$element[a](this.$element[0][b])},hide:function(){var a=this.dimension();this.reset(this.$element[a]());this.transition("removeClass","hide","hidden");this.$element[a](0)},reset:function(a){var b=this.dimension();this.$element.removeClass("collapse")[b](a||"auto")[0].offsetWidth;this.$element[a?"addClass":"removeClass"]("collapse");return this},transition:function(a,b,d){var f=this,e=function(){"show"==b&&f.reset();f.$element.trigger(d)};
this.$element.trigger(b)[a]("in");c.support.transition&&this.$element.hasClass("collapse")?this.$element.one(c.support.transition.end,e):e()},toggle:function(){this[this.$element.hasClass("in")?"hide":"show"]()}};c.fn.collapse=function(a){return this.each(function(){var b=c(this),d=b.data("collapse"),f="object"==typeof a&&a;d||b.data("collapse",d=new e(this,f));if("string"==typeof a)d[a]()})};c.fn.collapse.defaults={toggle:!0};c.fn.collapse.Constructor=e;c(function(){c("body").on("click.collapse.data-api",
"[data-toggle=collapse]",function(a){var b=c(this),d,a=b.attr("data-target")||a.preventDefault()||(d=b.attr("href"))&&d.replace(/.*(?=#[^\s]+$)/,""),b=c(a).data("collapse")?"toggle":b.data();c(a).collapse(b)})})}(window.jQuery);
!function(b){var f=function(a,c){this.$element=b(a);this.options=b.extend({},b.fn.carousel.defaults,c);this.options.slide&&this.slide(this.options.slide);"hover"==this.options.pause&&this.$element.on("mouseenter",b.proxy(this.pause,this)).on("mouseleave",b.proxy(this.cycle,this))};f.prototype={cycle:function(){this.interval=setInterval(b.proxy(this.next,this),this.options.interval);return this},to:function(a){var c=this.$element.find(".active"),e=c.parent().children(),c=e.index(c),d=this;return a>
e.length-1||0>a?void 0:this.sliding?this.$element.one("slid",function(){d.to(a)}):c==a?this.pause().cycle():this.slide(a>c?"next":"prev",b(e[a]))},pause:function(){clearInterval(this.interval);this.interval=null;return this},next:function(){return this.sliding?void 0:this.slide("next")},prev:function(){return this.sliding?void 0:this.slide("prev")},slide:function(a,c){var e=this.$element.find(".active"),d=c||e[a](),f=this.interval,g="next"==a?"left":"right",i="next"==a?"first":"last",h=this;this.sliding=
!0;f&&this.pause();d=d.length?d:this.$element.find(".item")[i]();if(!d.hasClass("active"))return!b.support.transition&&this.$element.hasClass("slide")?(this.$element.trigger("slide"),e.removeClass("active"),d.addClass("active"),this.sliding=!1,this.$element.trigger("slid")):(d.addClass(a),d[0].offsetWidth,e.addClass(g),d.addClass(g),this.$element.trigger("slide"),this.$element.one(b.support.transition.end,function(){d.removeClass([a,g].join(" ")).addClass("active");e.removeClass(["active",g].join(" "));
h.sliding=!1;setTimeout(function(){h.$element.trigger("slid")},0)})),f&&this.cycle(),this}};b.fn.carousel=function(a){return this.each(function(){var c=b(this),e=c.data("carousel"),d="object"==typeof a&&a;e||c.data("carousel",e=new f(this,d));if("number"==typeof a)e.to(a);else if("string"==typeof a||(a=d.slide))e[a]();else e.cycle()})};b.fn.carousel.defaults={interval:5E3,pause:"hover"};b.fn.carousel.Constructor=f;b(function(){b("body").on("click.carousel.data-api","[data-slide]",function(a){var c=
b(this),e,d=b(c.attr("data-target")||(e=c.attr("href"))&&e.replace(/.*(?=#[^\s]+$)/,"")),c=!d.data("modal")&&b.extend({},d.data(),c.data());d.carousel(c);a.preventDefault()})})}(window.jQuery);
(function(l,F){function q(a,b){this._d=a;this._isUTC=!!b}function g(a,b){for(var c=a+"";c.length<b;)c="0"+c;return c}function x(a,b,c,d){var f="string"===typeof b,e=f?{}:b;f&&d&&(e[b]=+d);b=(e.ms||e.milliseconds||0)+1E3*(e.s||e.seconds||0)+6E4*(e.m||e.minutes||0)+36E5*(e.h||e.hours||0);d=(e.d||e.days||0)+7*(e.w||e.weeks||0);e=(e.M||e.months||0)+12*(e.y||e.years||0);b&&a.setTime(+a+b*c);d&&a.setDate(a.getDate()+d*c);e&&(b=a.getDate(),a.setDate(1),a.setMonth(a.getMonth()+e*c),a.setDate(Math.min((new l(a.getFullYear(),
a.getMonth()+1,0)).getDate(),b)));return a}function r(a){return"[object Array]"===Object.prototype.toString.call(a)}function y(a){return new l(a[0],a[1]||0,a[2]||1,a[3]||0,a[4]||0,a[5]||0,a[6]||0)}function s(a,b){function c(b){var k;switch(b){case "M":return d+1;case "Mo":return d+1+j(d+1);case "MM":return g(d+1,2);case "MMM":return f.monthsShort[d];case "MMMM":return f.months[d];case "D":return m;case "Do":return m+j(m);case "DD":return g(m,2);case "DDD":return b=new l(e,d,m),k=new l(e,0,1),~~((b-
k)/864E5+1.5);case "DDDo":return b=c("DDD"),b+j(b);case "DDDD":return g(c("DDD"),3);case "d":return o;case "do":return o+j(o);case "ddd":return f.weekdaysShort[o];case "dddd":return f.weekdays[o];case "w":return b=new l(e,d,m-o+5),k=new l(b.getFullYear(),0,4),~~((b-k)/864E5/7+1.5);case "wo":return b=c("w"),b+j(b);case "ww":return g(c("w"),2);case "YY":return g(e%100,2);case "YYYY":return e;case "a":return 11<h?i.pm:i.am;case "A":return 11<h?i.PM:i.AM;case "H":return h;case "HH":return g(h,2);case "h":return h%
12||12;case "hh":return g(h%12||12,2);case "m":return z;case "mm":return g(z,2);case "s":return A;case "ss":return g(A,2);case "zz":case "z":return(a._d.toString().match(G)||[""])[0].replace(H,"");case "Z":return(0>n?"-":"+")+g(~~(Math.abs(n)/60),2)+":"+g(~~(Math.abs(n)%60),2);case "ZZ":return(0>n?"-":"+")+g(~~(10*Math.abs(n)/6),4);case "L":case "LL":case "LLL":case "LLLL":case "LT":return s(a,f.longDateFormat[b]);default:return b.replace(/(^\[)|(\\)|\]$/g,"")}}var d=a.month(),m=a.date(),e=a.year(),
o=a.day(),h=a.hours(),z=a.minutes(),A=a.seconds(),n=-a.zone(),j=f.ordinal,i=f.meridiem;return b.replace(I,c)}function t(a,b){var c=[0,0,1,0,0,0,0],d=0,m=0,e=!1,o=a.match(u),h=b.match(J),g=Math.min(o.length,h.length),k,n;for(k=0;k<g;k++){var j=o[k],i=void 0;switch(h[k]){case "M":case "MM":c[1]=~~j-1;break;case "MMM":case "MMMM":for(i=0;12>i;i++)if(f.monthsParse[i].test(j)){c[1]=i;break}break;case "D":case "DD":case "DDD":case "DDDD":c[2]=~~j;break;case "YY":j=~~j;c[0]=j+(70<j?1900:2E3);break;case "YYYY":c[0]=
~~Math.abs(j);break;case "a":case "A":n="pm"===j.toLowerCase();break;case "H":case "HH":case "h":case "hh":c[3]=~~j;break;case "m":case "mm":c[4]=~~j;break;case "s":case "ss":c[5]=~~j;break;case "Z":case "ZZ":e=!0,(i=(j||"").match(K))&&i[1]&&(d=~~i[1]),i&&i[2]&&(m=~~i[2]),i&&"+"===i[0]&&(d=-d,m=-m)}}n&&12>c[3]&&(c[3]+=12);!1===n&&12===c[3]&&(c[3]=0);c[3]+=d;c[4]+=m;return e?new l(l.UTC.apply({},c)):y(c)}function L(a,b,c){var d=f.relativeTime[a];return"function"===typeof d?d(b||1,!!c,a):d.replace(/%d/i,
b||1)}function B(a,b){f.fn[a]=function(a){var d=this._isUTC?"UTC":"";return null!=a?(this._d["set"+d+b](a),this):this._d["get"+d+b]()}}var f,k=Math.round,v={},C="undefined"!==typeof module,D="months,monthsShort,monthsParse,weekdays,weekdaysShort,longDateFormat,calendar,relativeTime,ordinal,meridiem".split(","),p,M=/^\/?Date\((\-?\d+)/i,I=/(\[[^\[]*\])|(\\)?(Mo|MM?M?M?|Do|DDDo|DD?D?D?|dddd?|do?|w[o|w]?|YYYY|YY|a|A|hh?|HH?|mm?|ss?|zz?|ZZ?|LT|LL?L?L?)/g,H=/[^A-Z]/g,G=/\([A-Za-z ]+\)|:[0-9]{2} [A-Z]{3} /g,
J=/(\\)?(MM?M?M?|dd?d?d|DD?D?D?|YYYY|YY|a|A|hh?|HH?|mm?|ss?|ZZ?|T)/g,u=/(\\)?([0-9]+|([a-zA-Z\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+|([\+\-]\d\d:?\d\d))/gi,N=/\d{4}.\d\d.\d\d(T(\d\d(.\d\d(.\d\d)?)?)?([\+\-]\d\d:?\d\d)?)?/,E=[["HH:mm:ss",/T\d\d:\d\d:\d\d/],["HH:mm",/T\d\d:\d\d/],["HH",/T\d\d/]],K=/([\+\-]|\d\d)/gi,w="Month,Date,Hours,Minutes,Seconds,Milliseconds".split(",");f=function(a,b){if(null===a||""===a)return null;var c;if(a&&a._d instanceof l)c=new l(+a._d);else if(b)if(r(b)){var d=a.match(u),
f=99,e,k,h;for(e=0;e<b.length;e++){k=t(a,b[e]);h=d;for(var g=s(new q(k),b[e]).match(u),p=Math.min(h.length,g.length),n=Math.abs(h.length-g.length),j=0,i=void 0,i=0;i<p;i++)~~h[i]!==~~g[i]&&j++;h=j+n;h<f&&(f=h,c=k)}}else c=t(a,b);else if(c=M.exec(a),a===F)c=new l;else if(c)c=new l(+c[1]);else if(a instanceof l)c=a;else if(r(a))c=y(a);else if("string"===typeof a)if(c="YYYY-MM-DDT",N.exec(a)){for(d=0;3>d;d++)if(E[d][1].exec(a)){c+=E[d][0];break}c=t(a,c+"Z")}else c=new l(a);else c=new l(a);return new q(c)};
f.utc=function(a,b){return r(a)?new q(new l(l.UTC.apply({},a)),!0):b&&a?f(a+" 0",b+" Z").utc():f(a).utc()};f.humanizeDuration=function(a,b,c){var a=+a,d=f.relativeTime;switch(b){case "seconds":a*=1E3;break;case "minutes":a*=6E4;break;case "hours":a*=36E5;break;case "days":a*=864E5;break;case "weeks":a*=6048E5;break;case "months":a*=2592E6;break;case "years":a*=31536E6;break;default:c=!!b}var b=!c,m=k(Math.abs(a)/1E3),e=k(m/60),g=k(e/60),h=k(g/24),l=k(h/365),m=10>m&&["s",m]||55>m&&["ss",m]||1===e&&
["m"]||45>e&&["mm",e]||1===g&&["h"]||22>g&&["hh",g]||1===h&&["d"]||25>=h&&["dd",h]||45>=h&&["M"]||345>h&&["MM",k(h/30)]||1===l&&["y"]||["yy",l];m[2]=b;b=L.apply({},m);return c?(0>=a?d.past:d.future).replace(/%s/i,b):b};f.version="1.5.0";f.defaultFormat="YYYY-MM-DDTHH:mm:ssZ";f.lang=function(a,b){var c,d;d=[];if(b){for(c=0;12>c;c++)d[c]=RegExp("^"+b.months[c]+"|^"+b.monthsShort[c].replace(".",""),"i");b.monthsParse=b.monthsParse||d;v[a]=b}if(v[a])for(c=0;c<D.length;c++)d=D[c],f[d]=v[a][d]||f[d];else C&&
(c=require("./lang/"+a),f.lang(a,c))};f.lang("en",{months:"January,February,March,April,May,June,July,August,September,October,November,December".split(","),monthsShort:"Jan,Feb,Mar,Apr,May,Jun,Jul,Aug,Sep,Oct,Nov,Dec".split(","),weekdays:"Sunday,Monday,Tuesday,Wednesday,Thursday,Friday,Saturday".split(","),weekdaysShort:"Sun,Mon,Tue,Wed,Thu,Fri,Sat".split(","),longDateFormat:{LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D YYYY",LLL:"MMMM D YYYY LT",LLLL:"dddd, MMMM D YYYY LT"},meridiem:{AM:"AM",am:"am",PM:"PM",
pm:"pm"},calendar:{sameDay:"[Today at] LT",nextDay:"[Tomorrow at] LT",nextWeek:"dddd [at] LT",lastDay:"[Yesterday at] LT",lastWeek:"[last] dddd [at] LT",sameElse:"L"},relativeTime:{future:"in %s",past:"%s ago",s:"a few seconds",ss:"%d seconds",m:"a minute",mm:"%d minutes",h:"an hour",hh:"%d hours",d:"a day",dd:"%d days",M:"a month",MM:"%d months",y:"a year",yy:"%d years"},ordinal:function(a){var b=a%10;return 1===~~(a%100/10)?"th":1===b?"st":2===b?"nd":3===b?"rd":"th"}});f.isMoment=function(a){return a instanceof
q};f.fn=q.prototype={clone:function(){return f(this)},valueOf:function(){return+this._d},"native":function(){return this._d},toString:function(){return this._d.toString()},toDate:function(){return this._d},utc:function(){this._isUTC=!0;return this},local:function(){this._isUTC=!1;return this},format:function(a){return s(this,a?a:f.defaultFormat)},add:function(a,b){this._d=x(this._d,a,1,b);return this},subtract:function(a,b){this._d=x(this._d,a,-1,b);return this},diff:function(a,b,c){var a=f(a),d=
6E4*(this.zone()-a.zone()),d=this._d-a._d-d,g=this.year()-a.year(),e=this.month()-a.month(),a=this.date()-a.date(),b="months"===b?12*g+e+a/30:"years"===b?g+e/12:"seconds"===b?d/1E3:"minutes"===b?d/6E4:"hours"===b?d/36E5:"days"===b?d/864E5:"weeks"===b?d/6048E5:d;return c?b:k(b)},from:function(a,b){return f.humanizeDuration(this.diff(a),!b)},fromNow:function(a){return this.from(f(),a)},calendar:function(){var a=this.diff(f().sod(),"days",!0),b=f.calendar,c=b.sameElse,a=-6>a?c:-1>a?b.lastWeek:0>a?b.lastDay:
1>a?b.sameDay:2>a?b.nextDay:7>a?b.nextWeek:c;return this.format("function"===typeof a?a.apply(this):a)},isLeapYear:function(){var a=this.year();return 0===a%4&&0!==a%100||0===a%400},isDST:function(){return this.zone()<f([this.year()]).zone()||this.zone()<f([this.year(),5]).zone()},day:function(a){var b=this._d.getDay();return null==a?b:this.add({d:a-b})},sod:function(){return this.clone().hours(0).minutes(0).seconds(0).milliseconds(0)},eod:function(){return this.sod().add({d:1,ms:-1})},zone:function(){return this._isUTC?
0:this._d.getTimezoneOffset()},daysInMonth:function(){return this.clone().month(this.month()+1).date(0).date()}};for(p=0;p<w.length;p++)B(w[p].toLowerCase(),w[p]);B("year","FullYear");C&&(module.exports=f);"undefined"!==typeof window&&(window.moment=f);"function"===typeof define&&define.amd&&define("moment",[],function(){return f})})(Date);
...
(function(){function q(a,c,d){if(a===c)return 0!==a||1/a==1/c;if(null==a)return a===c;var e=typeof a;if(e!=typeof c||!a!=!c)return!1;if(b.isNaN(a))return b.isNaN(c);var f=b.isString(a),g=b.isString(c);if(f||g)return f&&g&&""+a==""+c;f=b.isNumber(a);g=b.isNumber(c);if(f||g)return f&&g&&+a==+c;f=b.isBoolean(a);g=b.isBoolean(c);if(f||g)return f&&g&&+a==+c;f=b.isDate(a);g=b.isDate(c);if(f||g)return f&&g&&a.getTime()==c.getTime();f=b.isRegExp(a);g=b.isRegExp(c);if(f||g)return f&&g&&a.source==c.source&&
a.global==c.global&&a.multiline==c.multiline&&a.ignoreCase==c.ignoreCase;if("object"!=e)return!1;a._chain&&(a=a._wrapped);c._chain&&(c=c._wrapped);if(b.isFunction(a.isEqual))return a.isEqual(c);for(e=d.length;e--;)if(d[e]==a)return!0;d.push(a);e=0;f=!0;if(a.length===+a.length||c.length===+c.length){if(e=a.length,f=e==c.length)for(;e--&&(f=e in a==e in c&&q(a[e],c[e],d)););}else{for(var h in a)if(l.call(a,h)&&(e++,!(f=l.call(c,h)&&q(a[h],c[h],d))))break;if(f){for(h in c)if(l.call(c,h)&&!e--)break;
f=!e}}d.pop();return f}var r=this,F=r._,n={},k=Array.prototype,o=Object.prototype,i=k.slice,G=k.unshift,u=o.toString,l=o.hasOwnProperty,v=k.forEach,w=k.map,x=k.reduce,y=k.reduceRight,z=k.filter,A=k.every,B=k.some,p=k.indexOf,C=k.lastIndexOf,o=Array.isArray,H=Object.keys,s=Function.prototype.bind,b=function(a){return new m(a)};"undefined"!==typeof module&&module.exports?(module.exports=b,b._=b):r._=b;b.VERSION="1.2.0";var j=b.each=b.forEach=function(a,c,b){if(a!=null)if(v&&a.forEach===v)a.forEach(c,
b);else if(a.length===+a.length)for(var e=0,f=a.length;e<f;e++){if(e in a&&c.call(b,a[e],e,a)===n)break}else for(e in a)if(l.call(a,e)&&c.call(b,a[e],e,a)===n)break};b.map=function(a,c,b){var e=[];if(a==null)return e;if(w&&a.map===w)return a.map(c,b);j(a,function(a,g,h){e[e.length]=c.call(b,a,g,h)});return e};b.reduce=b.foldl=b.inject=function(a,c,d,e){var f=d!==void 0;a==null&&(a=[]);if(x&&a.reduce===x){e&&(c=b.bind(c,e));return f?a.reduce(c,d):a.reduce(c)}j(a,function(a,b,i){if(f)d=c.call(e,d,a,
b,i);else{d=a;f=true}});if(!f)throw new TypeError("Reduce of empty array with no initial value");return d};b.reduceRight=b.foldr=function(a,c,d,e){a==null&&(a=[]);if(y&&a.reduceRight===y){e&&(c=b.bind(c,e));return d!==void 0?a.reduceRight(c,d):a.reduceRight(c)}a=(b.isArray(a)?a.slice():b.toArray(a)).reverse();return b.reduce(a,c,d,e)};b.find=b.detect=function(a,c,b){var e;D(a,function(a,g,h){if(c.call(b,a,g,h)){e=a;return true}});return e};b.filter=b.select=function(a,c,b){var e=[];if(a==null)return e;
...
b.difference=function(a,c){return b.filter(a,function(a){return!b.include(c,a)})};b.zip=function(){for(var a=i.call(arguments),c=b.max(b.pluck(a,"length")),d=Array(c),e=0;e<c;e++)d[e]=b.pluck(a,""+e);return d};b.indexOf=function(a,c,d){if(a==null)return-1;var e;if(d){d=b.sortedIndex(a,c);return a[d]===c?d:-1}if(p&&a.indexOf===p)return a.indexOf(c);d=0;for(e=a.length;d<e;d++)if(a[d]===c)return d;return-1};b.lastIndexOf=function(a,b){if(a==null)return-1;if(C&&a.lastIndexOf===C)return a.lastIndexOf(b);
for(var d=a.length;d--;)if(a[d]===b)return d;return-1};b.range=function(a,b,d){if(arguments.length<=1){b=a||0;a=0}for(var d=arguments[2]||1,e=Math.max(Math.ceil((b-a)/d),0),f=0,g=Array(e);f<e;){g[f++]=a;a=a+d}return g};b.bind=function(a,b){if(a.bind===s&&s)return s.apply(a,i.call(arguments,1));var d=i.call(arguments,2);return function(){return a.apply(b,d.concat(i.call(arguments)))}};b.bindAll=function(a){var c=i.call(arguments,1);c.length==0&&(c=b.functions(a));j(c,function(c){a[c]=b.bind(a[c],a)});
...
function set_last_data(a,d){d=JSON.stringify(d);localStorage?localStorage.setItem(a+"-data",d):$("body").data(a+"-data",d)}function set_last_data_timestamp(a,d){localStorage?localStorage.setItem(a+"-timestamp",d):$("body").data(a+"-timestamp",d)}function get_last_data(a){a=localStorage?localStorage.getItem(a+"-data"):$("body").data(a+"-data");return!a?void 0:JSON.parse(a)}
function get_last_data_timestamp(a){(a=localStorage?localStorage.getItem(a+"-timestamp"):$("body").data(a+"-timestamp"))||(a=0);return parseInt(a)}function handle_autofill(a){if(a&&a.autofill)for(var d in a.autofill){var b=$("#"+d);b&&a.autofill[d]!=b.html()&&animate_change(b,a.autofill[d])}}
function animate_change(a,d,b){if(b||!a.data("animate-init"))if(a.data("animate-original-color")||(a.data("animate-original-color",a.css("color")),a.data("animate-original-bgcolor",a.css("background-color"))),isNaN(d))a.html(d),a.css("color","#FFFDF9").css("background-color","#FCF8E3"),a.animate({color:a.data("animate-original-color"),"background-color":a.data("animate-original-bgcolor")},2E3);else{var c=parseFloat(d);a.data("animate-init")||(a.data("animate-init",!0),a.css("color","#CCCCCC").css("background-color",
"#FCF8E3"),a.data("animate-target",d),new_data=parseFloat(a.html()),isNaN(new_data)&&(new_data=0),a.data("animate-step",Math.max(1,(c-new_data)/20)),c=new_data);c=Math.min(a.data("animate-target"),Math.floor(c+a.data("animate-step")));c>=a.data("animate-target")?(a.html(a.data("animate-target")),a.animate({color:a.data("animate-original-color"),"background-color":a.data("animate-original-bgcolor")},2E3),a.removeData("animate-init")):(a.html(c),setTimeout(function(){animate_change(a,c,true)},100))}}
(function(a){var d={init:function(b){var c=a.extend({short_timeout:300,long_timeout:1800,current_timeout:300,update_button_id:a(this).selector+"> .update_now_button",spinner_id:a(this).selector+"> .update_now_button > .update_progress_indicator",next_reload_id:a(this).selector+"> small > .update_next_reload",refresh_callback:"fetch_data();",refresh_twitter_callback:"update_twitter();",ago_id:a(this).selector+"> small > .update_ago",thiselem:a(this),filewatch:!1},b);c.current_timeout=c.short_timeout;
a(this).html('<small><span class="update_ago"></span> <span class="update_next_reload"></span></small> <button class="btn btn-small update_now_button">Update now <span class="update_progress_indicator"><img src="/img/loading-mini.gif"></span></button>');a(this).data("pagerefresh_settings",c);a(c.update_button_id).click(function(){c.thiselem.pagerefresh("fetch")});if(!a("body").data(c.filewatch+"-localstorage-loaded")){a("body").data(c.filewatch+"-localstorage-loaded",!0);if((data=get_last_data(c.filewatch))&&
data.content)a("body").data("pagerefresh-data",data),eval(c.refresh_callback),c.thiselem.pagerefresh("autofill"),c.thiselem.pagerefresh("fetch_done",1E3*a("body").data("pagerefresh-data").content_timestamp);if((twitter=get_last_data("twitter.json"))&&twitter.content)a("body").data("pagerefresh-twitter",twitter),eval(c.refresh_twitter_callback)}EventSource&&c.filewatch&&(a(this).pagerefresh("savesetting","sse",!0),c.sse=!0,a(this).pagerefresh("enableSSE",c.thiselem));c.sse?a(c.next_reload_id).data("reload-timestamp",
(new Date).getTime()+1E3*c.long_timeout):a(c.next_reload_id).data("reload-timestamp",0);a(window).blur(function(){var b=c.thiselem.data("pagerefresh_settings");b.sse&&b.thiselem.data("sserunning")&&a(this).pagerefresh("disableSSE",c.thiselem);var d=a(c.next_reload_id).data("reload-timestamp");if(d){b=(new Date).getTime()+c.long_timeout*1E3+c.short_timeout*1E3;d=d+c.long_timeout*1E3;a(c.next_reload_id).data("reload-timestamp",Math.min(b,d))}else a(c.next_reload_id).data("reload-timestamp",(new Date).getTime()+
c.long_timeout*1E3);c.thiselem.pagerefresh("savesetting","current_timeout",c.long_timeout)});a(window).focus(function(){if(c.thiselem.data("pagerefresh_settings").sse&&!c.thiselem.data("sserunning"))a(this).pagerefresh("enableSSE",c.thiselem);else{var b=a(c.next_reload_id).data("reload-timestamp");b?a(c.next_reload_id).data("reload-timestamp",b-c.long_timeout*1E3):a(c.next_reload_id).data("reload-timestamp",(new Date).getTime()+c.short_timeout*1E3);c.thiselem.pagerefresh("savesetting","current_timeout",
c.short_timeout)}});a(this).pagerefresh("update")},disableSSE:function(a){var c=a.data("ssesource");c&&(c.close(),a.data("sserunning",!1))},enableSSE:function(b){var c=b.data("pagerefresh_settings"),b=new EventSource("/sse.php?file="+c.filewatch);c.thiselem.data("sserunning",!0);b.addEventListener("message",function(){},!1);b.addEventListener("changeevent",function(b){b=JSON.parse(b.data);c.thiselem.data("sserunning",!0);get_last_data_timestamp(c.filewatch)<b.timestamp-20&&a(c.next_reload_id).data("reload-timestamp",
0)},!1);b.addEventListener("manifestchange",function(){c.thiselem.data("sserunning",!0);try{window.window.applicationCache.update()}catch(a){}},!1);b.addEventListener("open",function(){c.thiselem.data("sserunning",!0);c.thiselem.pagerefresh("savesetting","sse",!0)},!1);b.addEventListener("error",function(){c.thiselem.data("sserunning",!1);c.thiselem.pagerefresh("savesetting","sse",!1)},!1);c.thiselem.data("ssesource",b)},savesetting:function(b,c){var d=a(this).data("pagerefresh_settings");d?(d[b]=
c,a(this).data("pagerefresh_settings",d)):console.log("Failed to save setting",b," with value ",c," using element ",a(this))},update:function(){var b=a(this).data("pagerefresh_settings");if(b){b.timestamp?a(b.ago_id).html(moment(b.timestamp).fromNow()+"."):a(b.ago_id).html("");var c=a(b.next_reload_id).data("reload-timestamp");b.thiselem.data("sserunning")?moment(c)<moment()?(a(b.next_reload_id).html("Next reload right now"),a(this).pagerefresh("fetch")):(a(b.next_reload_id).html("Next reload when new data is available"),
a(b.next_reload_id).data("reload-timestamp",(new Date).getTime()+6E4*b.current_timeout)):!c||moment(c)<moment()?(a(b.next_reload_id).html("Next reload right now"),a(this).pagerefresh("fetch")):a(b.next_reload_id).html("Next reload "+moment(c).fromNow());setTimeout("$('"+b.thiselem.selector+"').pagerefresh('update');",1E3)}},destroy:function(){return this.each(function(){var b=a(this);b.data("pagerefresh_settings")&&(b.empty(),b.removeData("pagerefresh_settings"))})},autofill:function(){return this.each(function(){var b=
a(this).data("pagerefresh_settings");if(b){if(b=get_last_data(b.filewatch))b=b.content;handle_autofill(b)}})},fetch:function(){var b=a(this).data("pagerefresh_settings");if(b){a(b.next_reload_id).data("reload-timestamp",(new Date).getTime()+1E3*b.current_timeout);a(b.spinner_id).show();a(b.update_button_id).addClass("disabled");var c="/json.php?filename="+b.filewatch+"&last_data="+get_last_data_timestamp(b.filewatch);a.get(c,function(c){"success"==c.status&&(c.twitter&&(a("body").data("pagerefresh-twitter",
c.twitter),set_last_data("twitter.json",c.twitter),eval(b.refresh_twitter_callback)),c.data&&(a("body").data("pagerefresh-data",c.data),set_last_data(b.filewatch,c.data),eval(b.refresh_callback),set_last_data_timestamp(b.filewatch,c.data.content_timestamp)),b.thiselem.pagerefresh("fetch_done",1E3*a("body").data("pagerefresh-data").content_timestamp),b.thiselem.pagerefresh("autofill"))},"json")}else console.log("No settings available (fetch)")},fetch_done:function(b){a(this).pagerefresh("savesetting",
"timestamp",b);(b=a(this).data("pagerefresh_settings"))?setTimeout('$("'+b.update_button_id+'").removeClass("disabled");$("'+b.spinner_id+'").hide();',1E3):console.log("No settings available (fetch_done)")}};a.fn.pagerefresh=function(b){if(d[b])return d[b].apply(this,Array.prototype.slice.call(arguments,1));if("object"===typeof b||!b)return d.init.apply(this,arguments);a.error("Method "+b+" does not exist on jQuery.pagrefresh")}})(jQuery);
...
!1),window.applicationCache.addEventListener("checking",function(){$("#reload-button").addClass("disabled");$("#reload-button").html("Checking...")},!1),window.applicationCache.addEventListener("error",function(a){console.log(a)},!1)}catch(e$$19){$("#cache-update-status").hide(),$("#cache-status").hide()}
jQuery.fn.urlize=function(){0<this.length&&this.each(function(a,d){var c=$(d).html(),b=c.match(/\b(http:\/\/|www\.|http:\/\/www\.)[^ <]{2,200}\b/g);if(b)for(a=0;a<b.length;a++)var e=0===b[a].indexOf("http://")||0===b[a].indexOf("https://")?"":"http://",c=c.replace(b[a],"<a target='_blank' href='"+e+b[a]+"'>"+b[a]+"</a>");$(d).html(c)})};
function update_twitter(){var a=$("body").data("pagerefresh-twitter").content;$("#twitter_footer").html("<blockquote><p id='twitter_status'>"+a.status+"</p><small><a href='http://twitter.com/futurice'><i class='icon-retweet'></i> @futurice "+a.status_ago+"</a></small></blockquote>");$("#twitter_status").urlize()}$(document).ready(function(){hide_popovers();$("[rel=popover]").popover({placement:popover_placement});setInterval("check_appcache_update();",18E5)});
